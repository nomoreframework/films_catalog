        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    U_serId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FilmModel", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FilmModel_AspNetUsers_U_serId",
                        column: x => x.U_serId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PosterModel", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PosterModel_FilmModel_FilmModelId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FilmModel_U_serId",
                table: "FilmModel",
                column: "U_serId");

            migrationBuilder.CreateIndex(
                name: "IX_PosterModel_FilmModelId",
                table: "PosterModel",
                column: "FilmModelId",
                unique: true);
        }
